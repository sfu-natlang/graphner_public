...
./Get_GENE_eval_from_marginals_and_ids.o 0 ../banner-chemdner/output/ids.txt MiddleFiles/marginals_combined_viterbi.txt MiddleFiles/GENE.eval_marginals_combined_viterbi 3 MiddleFiles/LabelsOrder.txt >& logfile
