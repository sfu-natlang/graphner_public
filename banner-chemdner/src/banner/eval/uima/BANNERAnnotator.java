...
public class BANNERAnnotator extends JCasAnnotator_ImplBase {
	...
	PostProcessor postProcessor;
        ...
        WordVectorClasses wordVectorClasses;
	@Override
	...
	public void initialize(UimaContext aContext)
		...
		try {
			...
			postProcessor = BANNER.getPostProcessor(config);
                        brownClusters = BANNER.getBrownClusters(config);
                        wordEmbeddings = BANNER.getWordEmbeddings(config);
                        wordVectorClasses = BANNER.getWordVectorClasses(config);
			...
			tagger = CRFTagger.load(new File(modelFilename), lemmatiser, posTagger, dictionary, brownClusters, wordEmbeddings, wordVectorClasses);
